...
export class contactService {
  ...
  public getContactById(id: string): Observable<Contact> {
    const contact: Contact = this._contacts$.getValue().find(contact => contact._id === id)
  ...
  private _addContact(contact: Contact) {
    const newContact = new Contact(this._makeId(), contact.name, contact.email, contact.phone);
